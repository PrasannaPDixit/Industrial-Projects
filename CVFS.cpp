...
/*
    START
        Understand the linux system commands working
        Tokenize the user input and separateout the words
        First word will be the command and others are its parameters
        Compare the commands and call the respective user defined functions
        Use indefinite while loop to give the experience of customised shell   
    End
*/
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminating the Prasanna's Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"write") == 0)
            {
                ...
                if(ret == -2)
                    printf("ERROR : There is no sfficient memory to wrie\n");
                if(ret == -3)
